  ...
  return [
    {
      ...
      items: [
        "Keep only the current NDA, Partner Agreement, and onboarding materials here.",
    ...
    },
    {
      ...
      items: [
        ...
        "NDA and Partner Agreement acceptance records remain visible in legal onboarding.",
  ...
  return (
    <>
      <WorkspacePageHeader
        ...
        title="Documents"
        subtitle="Access the NDA, Partner Agreement, onboarding guides, and GoAccess operating documents tied to your approved vendor account."
